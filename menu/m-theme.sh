...
echo -e "$COLOR1 ${NC}                ${WH}• YakkoRasZ14 •${NC}                 $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e ""
...
01 | 1)
clear
echo "blue" >/etc/autoscriptvps/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
02 | 2)
clear
echo "red" >/etc/autoscriptvps/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
03 | 3)
clear
echo "yellow" >/etc/autoscriptvps/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
04 | 4)
clear
echo "cyan" >/etc/autoscriptvps/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
05 | 5)
clear
echo "green" >/etc/autoscriptvps/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
06 | 6)
clear
echo "magenta" >/etc/autoscriptvps/theme/color.conf
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
