...
https://api.whatsapp.com/send/?phone=6281949400586&text&type=phone_number&app_absent=0
<h2><hr>
<h2 align="center">
🚀 Autoscript SSH XRAY Websocket Multiport By YOKKO EDDY STORE 🚀
<h2><hr>
...
🚀 Update VPS Kamu Dulu Sebelum Instal Script 🚀<br>
 ...
 apt-get update && apt-get upgrade -y && reboot
  ...
  ```
<h2 align="center">
🚀 Installation Script By YOKKO EDDY STORE 🚀<br>

  ```html
sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl && wget https://raw.githubusercontent.com/YakkoRasZ14/autoscriptvps/main/setup.sh && chmod +x setup.sh && ./setup.sh
